...
export const adminApi = {
  ...
  uploadBackground: (file: File) => { const form = new FormData(); form.append('file', file); return client.post('/api/admin/background', form, { headers: { 'Content-Type': 'multipart/form-data' } }).then(r => r.data) },
